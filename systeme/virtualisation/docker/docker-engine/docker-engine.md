...
<pre>
* 0.0.0.0:2375
	* 0.0.0.0: C'est � dire on peut la consulter depuis n'importe quelle machine
...
1-<b>choco</b>: Pour installer le client docker on utilise 'choco'
	...
	* installation : https://chocolatey.org/install#individual (suivre la proc�dure)

2- une fois choco install�
	* install� docker : <b>choco install docker-cli</b>
	* https://community.chocolatey.org/packages/docker-cli#individual

</pre>

### �tablir une connexion avec docker-engine
<pre>
