...
insert into categories (code, libelle) values (10,'Imprimantes');
insert into categories (code, libelle) values (20,'Scanners');
insert into categories (code, libelle) values (30,'Claviers');
insert into categories (code, libelle) values (40,'Souris');
insert into categories (code, libelle) values (50,'Clés USB');
set identity_insert categories off
go
PRINT 'Ajouter des articles'
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('IMP01','Canon LBP 6200d',109.9,10);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('IMP02','Canon LBP-7200Cdn',299.9,10);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('IMP03','Canon LBP-5050n',189.9,10);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('IMP04','Epson WorkForce Pro',159.99,10);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('IMP05','Brother HL4140-CN',269.90,10);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('SCA06','Canon Lide 210',83.90,20);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('SCA07','Canon P-150',269.90,20);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('SCA08','Fujitsu fi-5530C2',3059.89,20);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('SCA09','Epson Perfection V750 Pro',519.90,20);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('SCA10','Epson Perfection V600',269.90,20);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('CLA11','Logitech G19',131.89,30);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('CLA12','Logitech DiNovo Mini',79.99,30);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('CLA13','Microsoft Arc Keyboard',42.95,30);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('CLA14','Microsft Digital Media Keyboard',22.90,30);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('CLA15','Razer Black Window',74.89,30);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('SOU16','Logitech G500',44.99,40);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('SOU17','Microsoft Comfort Mouse 4500',15.89,40);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('SOU18','Logitech M185 Wireless Mouse',14.95,40);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('SOU19','Logitech M235 Wireless Mouse',18.90,40);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('SOU20','Microsoft Touch Mouse',59.90,40);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('CLE21','Corsair Flash Voyager',35.99,50);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('CLE22','Lexar Echo MX',14.99,50);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('CLE23','Kingston DTR500',23.99,50);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('CLE24','LaCie XtremMey',39.99,50);
insert into ARTICLES (reference, designation, prixht, code_cat) VALUES('CLE25','Scandisk Cruzer Edge',10.49,50);
...
begin
  ...
  declare @i int;
  declare carticles cursor for select reference from articles;
...
SELECT c.numero_cde,  sum(l.qte_cde*a.prixht), getdate(), c.etat_cde
from  COMMANDES c inner join LIGNES_CDE l on l.numero_cde=c.numero_cde
inner join ARTICLES a on a.REFERENCE=l.reference_art
group by c.numero_cde,c.etat_cde;

Print 'Ajouter des stocks'
insert into stocks (reference_art, depot, qte_stock)
 select reference, 'N',20 FROM ARTICLES;
 insert into stocks (reference_art, depot, qte_stock)
 select reference, 'P1',50 FROM ARTICLES;
-- Parcourir toutes les commandes 
...
while (@@FETCH_STATUS=0) begin
  update stocks set qte_stock=qte_stock-@qte where reference_art=@ref;
  fetch cQte into @ref, @qte;
end;
close cQte;
deallocate cQte;
